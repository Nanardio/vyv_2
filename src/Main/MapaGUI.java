...
public class MapaGUI extends JFrame {
	...
	public void ganar() {
		...
		JOptionPane.showMessageDialog(null, "¡FELICITACIONES! COMPLETÓ EL JUEGO EXITOSAMENTE.", "GANO", JOptionPane.DEFAULT_OPTION);	
		System.exit(0);
	}
	
	public void perder() {
		
		JOptionPane.showMessageDialog(null, "UPS. HAS PERDIDO. ¡SUERTE LA PROXIMA!", "PERDIÓ", JOptionPane.ERROR_MESSAGE);
		System.exit(0);
	}
